...
<div id="content-wrap" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-1" data-genuitec-path="/WormExp/WebRoot/begin.jsp">
<div id="up-wrap">
  <p><c:out value="${WE_PROPERTIES['we.header.description']}" escapeXml="false" /> Need help? <a href="javascript:void(0)" onclick="openManual();"> See the manual... </a></p>
</div>
        <div id="boxes">
        ...
        <div id="bottom-wrap">
		 <c:choose>
          				  ...
          				  <c:otherwise>
          				  <p class="error">Please note that all uploaded data and the generated results will be automatically deleted within 30 minutes due to limited memory!</p>
          				  </c:otherwise>
         </c:choose>
        </div>
        <div id="bottom-wrap">
            <c:if test="${!empty wetabs}">
                <div id="templates">
        			...
        			<p>Logs: 
                                <li> 21.10.22: The current output table contains duplicate gene entries, please see https://github.com/evoecogen/WormExp for an intermediate solution. 
                                <li> WormExp has been updated to v2!
                                <li> New sets are added on 2022.07.27!
        			<li> Adding new function to Analyse: gene sets are now sorted into multiple categories, allowing for more precise gene enrichment analysis! </p>
</div>
