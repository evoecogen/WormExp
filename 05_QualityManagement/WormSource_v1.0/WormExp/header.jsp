...
<div align="center" id="headercontainer">
  ...
  <div id="header">
    <a href="/${WE_PROPERTIES['webapp.path']}/" alt="Home" rel="NOFOLLOW"><img id="logo" src="/WormExp/img/logo.png" width="45px" height="43px" alt="Logo" /></a>
  ...
  <div id="menucontainer">
    <ul id="nav">
      <li id="home" <c:if test="${tab == 'begin'}">class="activelink"</c:if>>
        <a href="/${WE_PROPERTIES['webapp.path']}/">
