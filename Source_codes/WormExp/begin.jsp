        ...
        <div id="bottom-wrap">
            <c:if test="${!empty wetabs}">
                <div id="templates">
        			...
        			<p>Logs: <li> New sets are added on 2016.06.09!
        			<li>Adding new function to Search: start key words by @set (e.g., @set,elt-2) to explore related data sets without input IDs! </p>
</div>
