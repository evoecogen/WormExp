...
<html:xhtml/>
<link rel="stylesheet" type="text/css" href="css/contactForm.css" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-2" data-genuitec-path="/WormExp/WebRoot/contactForm.jsp"/>
<div class="body">
  <html:form action="/contactAction">
  <table cellspacing="0" cellpadding="3" border="0">
  <tr>
    <td><fmt:message key="contact.name"/></td>
    <td>
  ...
  <tr>
    <td><fmt:message key="contact.subject"/></td>
    <td><html:text property="subject" size="40"/></td>
  </tr>
  <tr>
    <td><fmt:message key="contact.message"/></td>
